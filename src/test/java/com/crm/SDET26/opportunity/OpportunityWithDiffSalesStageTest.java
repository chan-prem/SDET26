...
public class OpportunityWithDiffSalesStageTest extends BaseClass{
	
		
		@Test(groups = "RegressionTest")
		public void createOpportunitywithSalesStageClosedLost() throws Throwable
		{
	    ...
	    //verify
			...
			@Test(groups = "RegressionTest"  , retryAnalyzer = com.crm.SDET26.genericUtility.RetryAnalyserImpl.class)
			    ...
			    //Nav to Create Opportunity Page
			        OpportunityPage opp = new OpportunityPage(driver);
			        opp.getCreateOpprImg().click();
