...
public class CreateContactWithOrgNameAndLeadTestCheckbox {
	...
	//contacts
		...
		driver.findElement(By.name("lastname")).sendKeys("Chandar3");
	...
	//popup
		...
		for(String id : allid) {
			if(!main.equals(id)) {
				...
				driver.findElement(By.xpath("//a [text() = 'Prem']")).click();
				}
			}
